        ...
        <div className="rounded-2xl bg-slate-50 border border-slate-200 p-8 flex flex-col justify-between min-h-80">
            ...
            <div className="flex gap-2">
                ...
                <div className="mt-6 flex gap-8 bg-white p-4 rounded-xl border border-slate-200 w-fit shadow-sm mx-auto">
                    <div className="flex gap-2">
                        <div className=""><Image src={"/images/products/hdtv.png"} className="w-[32px] h-[32px]" width={10} height={10} alt="" /></div>
                        <div className="">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
                <button className="flex font-medium justify-center items-center gap-2 py-2 px-4 border-2 border-solid border-slate-700 rounded-full">
                    Add to Cart
                    <Image src={"/images/products/icon-red.png"} className="w-[32px] h-[32px]" width={10} height={10} alt="" />
                </button>
                <button className="flex font-medium justify-center items-center gap-2 py-2 px-4 border-2 border-solid border-slate-700 rounded-full">
                     Download Brochure
                    <Image src={"/images/products/download-icon.png"} className="w-[32px] h-[32px]" width={10} height={10} alt="" />
                </button>   
            </div>
        </div>
    </>);
